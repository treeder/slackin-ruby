Ruby version forked from [node slackin](http://rauchg.com/slackin).

Run it with:

```
SLACK_API_TOKEN=TOKEN SLACK_SUBDOMAIN=YOUR_SUB_DOMAIN ruby app.rb
```
...
[![Deploy](https://www.herokucdn.com/deploy/button.svg)](https://heroku.com/deploy?template=https://github.com/treeder/slackin/tree/0.5.0)
